    ...
    <section className="case-studies py-[10vh]">
        <div className="flex flex-col bottom-section body-padding gap-4">
            ...
            <div className="header-section flex justify-between">
                <div className="left-side gap-3 flex flex-col">
            ...
            <div className="flex hero-section">
                ...
                <div className="flex image-section w-1/2">
                    <Image
                        src="/images/pexels-christina-morillo-1181244-qlr0q7d26yjle1wxvxacrmfqfvrovgbuxrrizsl79c.jpg"
                        alt="Case Study 1"
                        width={600}
                        height={600}
            ...
            {/* Second Hero Section */}
            <div className="flex flex-row-reverse hero-section ">
                {/* Image */}
                <div className="flex card p-10 bg-[#def4fa]" id="second-card">
                    {/* Text */}
                    <div className="flex flex-col gap-4 self-center">
                ...
                <div className="flex image-section w-1/2">
                    <Image
                        src="/images/training-comressesd-scaled-qlr0q7d26yjle1wxvxacrmfqfvrovgbuxrrizsl79c.webp"
                        alt="Case Study 1"
                        width={600}
                        height={600}
                        className="object-cover rounded-lg self-center"
